...
public class OpenMeteoClient: IOpenMeteoClient 
{
    ...
    public async Task<OpenMeteoDailyForecastResponse?> GetDailyForecast(
        OpenMeteoDailyForecastRequest request,
        CancellationToken ct = default)
    {
        ...
        return await JsonSerializer.DeserializeAsync<OpenMeteoDailyForecastResponse>(s, opts, ct);
    }
